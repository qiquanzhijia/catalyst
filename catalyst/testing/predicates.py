...
from catalyst.testing.core import ensure_doctest
from catalyst.dispatch import dispatch
from catalyst.lib.adjustment import Adjustment
from catalyst.lib.labelarray import LabelArray
from catalyst.utils.functional import dzip_exact, instance
from catalyst.utils.math_utils import tolerant_equals
...
class wildcard(object):
    ...
    This is useful when using :func:`~catalyst.testing.predicates.assert_equal`
